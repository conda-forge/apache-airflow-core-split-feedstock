...
| [![Conda Recipe](https://img.shields.io/badge/recipe-apache--airflow--core--with--gunicorn-green.svg)](https://anaconda.org/conda-forge/apache-airflow-core-with-gunicorn) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/apache-airflow-core-with-gunicorn.svg)](https://anaconda.org/conda-forge/apache-airflow-core-with-gunicorn) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/apache-airflow-core-with-gunicorn.svg)](https://anaconda.org/conda-forge/apache-airflow-core-with-gunicorn) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/apache-airflow-core-with-gunicorn.svg)](https://anaconda.org/conda-forge/apache-airflow-core-with-gunicorn) |
...
Once the `conda-forge` channel has been enabled, `apache-airflow-core, apache-airflow-core-with-all, apache-airflow-core-with-async, apache-airflow-core-with-graphviz, apache-airflow-core-with-gunicorn, apache-airflow-core-with-kerberos, apache-airflow-core-with-otel, apache-airflow-core-with-statsd` can be installed with `conda`:

```
conda install apache-airflow-core apache-airflow-core-with-all apache-airflow-core-with-async apache-airflow-core-with-graphviz apache-airflow-core-with-gunicorn apache-airflow-core-with-kerberos apache-airflow-core-with-otel apache-airflow-core-with-statsd
```

or with `mamba`:

```
mamba install apache-airflow-core apache-airflow-core-with-all apache-airflow-core-with-async apache-airflow-core-with-graphviz apache-airflow-core-with-gunicorn apache-airflow-core-with-kerberos apache-airflow-core-with-otel apache-airflow-core-with-statsd
```
